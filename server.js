...
app.post('/api/shorturl', (req, res) => {
  ...
  console.log('prot and web', prot, web);
  if (prot.test(formated_url)) {
    console.log('prot_test_true');
    formated_url = formated_url.replace(prot, '')
  }
  if (web.test(formated_url)) {
    console.log('web_test_true');
    formated_url = formated_url.replace(web, '')
  }
  if (formated_url.charAt((formated_url.length)-1) === '/') {
    console.log('slash_test_true');
    formated_url = formated_url.slice(0, -1);
  }
